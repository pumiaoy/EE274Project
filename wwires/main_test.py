...
test_baches = 4 # number of baches to be tested
...
print(np.amax(np.absolute(Input)))
print(np.amax(np.absolute(Output)))
print(np.amax(np.absolute(np.subtract(Output,Input))))
print(np.count_nonzero(np.subtract(Output,Input)))